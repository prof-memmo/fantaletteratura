...
if (typeof firebase !== 'undefined') {
    ...
    window.db.collection = function(path) {
        // Eccezioni per le collezioni dell'Hub e degli altri giochi
        if (path.startsWith('hub_') || path === 'games_status' || path === 'vetrina' || path.startsWith('eroi_') || path.startsWith('palestra_') || path.startsWith('corte_')) return originalCollection(path);
